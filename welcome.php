...
<head>
    ...
    <style>
        ...
        .carousel-item img {
            max-height: 450px; /* Adjust the maximum height of the images */
...
<body>
    ...
    <div id="carousel_Example_Indicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="images/pexels-chevanon-324028.jpg" alt="First slide">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="images/pexels-enginakyurt-2299028.jpg" alt="Second slide">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src ="images/pexels-fotios-photos-907142.jpg" alt="Third slide">
                <div class="carousel-caption d-none d-md-block">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="card">
                    <img src="images/pexels-enginakyurt-2299028.jpg" class="card-img-top" alt="Meal 2">
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <img src="images/female-chef-plating.webp" class ="card-img-top1" alt="Special Food">
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <img src= "images\07130355-rwhkg-darkside-approaching-asian-dream-blood-and-sweet-a-800-days-journey-1_cover_1800x1200.webp" class="card-img-top1" alt="Special Beverage">
                    <div class="card-body">
