...
<div class="main">
    ...
    <div class="container">
        ...
        <form id="form1" style="width: 100%" action="Handlers/addproductHandler.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" id="desc" name="price" placeholder="Product Price(Rs)"/>
            <br>
            ...
            <div class="exp-cvc">
                <div class="card">
                    ...
                    <input class="inputCard" name="qty" id="expiry" type="text" placeholder="Quantity"/>
                    <br>
                </div>
                <div class="card">
                    <label for="expiry">Product Origin : </label>
                    <input class="inputCard" name="origin" id="expiry" type="text" placeholder="Origin"/>
                    <br>
                </div>
                <div class="card">
